...
// QueryAuth queries the auth edge of the User.
func (u *User) QueryAuth() *AuthQuery {
	return (&UserClient{u.config}).QueryAuth(u)
}

// QueryArticles queries the articles edge of the User.
func (u *User) QueryArticles() *ArticleQuery {
	return (&UserClient{u.config}).QueryArticles(u)
}
